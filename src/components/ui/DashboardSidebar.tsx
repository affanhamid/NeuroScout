...
export const DashboardSidebar = ({ players, onFilterChange, onSortChange }: DashboardSidebarProps) => {
          ...
          <Collapsible.Content className="mt-3 space-y-4">
            ...
            <div>
              ...
              {positions.map((position) => (
                <div key={position} className="flex items-center space-x-2 py-1">
                  <Checkbox.Root
            ...
            <div>
              ...
              {ageGroups.map((ageGroup) => (
                <div key={ageGroup} className="flex items-center space-x-2 py-1">
                  <Checkbox.Root
                    className="flex h-4 w-4 items-center justify-center rounded border border-gray-600 bg-gray-900 hover:bg-gray-800 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500"
        ...
        <div>
            ...
            <Select.Root onValueChange={onSortChange}>
                ...
                <Select.Content className="overflow-hidden bg-gray-900 rounded-lg shadow-lg border border-gray-700">
                    ...
                    {["overallScore", "decisionMaking", "spatialAwareness"].map((value) => (
                        <Select.Item
                        key={value}
                        value={value}
                        ...
                        >
                        <Select.ItemText>
                            {value === "overallScore" ? "Overall Score" :
                            value === "decisionMaking" ? "Decision Making" :
                            "Spatial Awareness"}
                        </Select.ItemText>
